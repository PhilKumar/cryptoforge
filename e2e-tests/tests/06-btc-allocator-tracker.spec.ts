...
test.describe('BTC Allocator And Buy Tracker', () => {
  test('latest 20% allocation seeds buy tracker and keeps weighted totals correct', async ({ page }) => {
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr')).toHaveCount(3);
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('Fib 2.0 / 20%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('₹66,128');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('₹129');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('Fib 4.0 / 30%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('₹65,264');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('₹193');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('Fib 8.0 / 50%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child')).toContainText('₹63,536');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('₹322');

    await page.fill('#btc-fib-high', '65914.53');
    await page.fill('#btc-fib-low', '65788');
    await page.fill('#btc-fib-capital', '100000');
    await page.click('.allocator-fib-actions button:has-text("Add Fib")');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('₹65,661.47');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('₹359');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('₹65,408.41');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('₹539');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('₹64,902.29');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('₹899');
    ...
    await page.fill('#btc-fib-low', '65788');
    await page.click('.allocator-fib-actions button:has-text("Add Fib")');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('₹65,376');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(0)).toContainText('₹124');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('₹64,552');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(1)).toContainText('₹187');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('₹62,904');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:first-child tbody tr').nth(2)).toContainText('₹311');
    await page.fill('#btc-alloc-high', '66992');
