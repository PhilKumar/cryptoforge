...
test.describe('BTC Allocator And Buy Tracker', () => {
  test('latest 20% allocation seeds buy tracker and keeps weighted totals correct', async ({ page }) => {
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹129');
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹193');
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹322');
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹124');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹64,552');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹187');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹62,904');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹311');
    await page.fill('#btc-alloc-high', '66992');
