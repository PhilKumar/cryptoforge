...
test.describe('BTC Allocator And Buy Tracker', () => {
  test('latest 20% allocation seeds buy tracker and keeps weighted totals correct', async ({ page }) => {
    ...
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row')).toHaveCount(3);
    ...
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('₹129');
    ...
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('₹193');
    ...
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('0.645%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('₹322');

    await page.fill('#btc-fib-high', '65914.53');
    await page.fill('#btc-fib-low', '65788');
    await page.fill('#btc-fib-capital', '100000');
    await page.click('.allocator-fib-actions button:has-text("Calculate Fib")');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('₹65,661.47');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('₹359');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('₹65,408.41');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('₹539');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('₹64,902.29');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('1.797%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('₹899');
    ...
    await page.fill('#btc-fib-low', '65788');
    await page.click('.allocator-fib-actions button:has-text("Calculate Fib")');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('₹65,376');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(0)).toContainText('₹124');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('₹64,552');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(1)).toContainText('₹187');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('₹62,904');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('0.622%');
    await expect(page.locator('#btc-fib-body tr.allocator-fib-main-row').nth(2)).toContainText('₹311');
    await page.fill('#btc-alloc-high', '66992');
