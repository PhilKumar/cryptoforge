...
test.describe('BTC Allocator And Buy Tracker', () => {
  test('latest 20% allocation seeds buy tracker and keeps weighted totals correct', async ({ page }) => {
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr')).toHaveCount(3);
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('Fib 2.0 / 20%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('₹66,128');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('1.290%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹258');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('Fib 4.0 / 30%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('₹65,264');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('2.579%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹774');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('Fib 8.0 / 50%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child')).toContainText('₹63,536');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('5.159%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹2,579');
    ...
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('1.986%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹397');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹65,408.41');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('2.364%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹709');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹64,902.29');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('3.119%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹1,560');
    ...
    await page.fill('#btc-fib-low', '65788');
    await page.click('.allocator-fib-actions button:has-text("Add Fib")');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹65,376');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('1.245%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(0)).toContainText('₹249');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹64,552');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('2.489%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(1)).toContainText('₹747');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹62,904');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('4.979%');
    await expect(page.locator('#btc-fib-ladders .allocator-fib-card:last-child tbody tr').nth(2)).toContainText('₹2,489');
    await page.fill('#btc-alloc-high', '66992');
